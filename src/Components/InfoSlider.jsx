...
const InfoSlider = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center relative py-10 md:py-16">
      <div className="md:w-1/2 h-auto md:h-full overflow-hidden">
        <Slider {...settings} className="h-full" initialSlide={selectedContentIndex}>
      ...
      <div className="md:w-1/2 p-8 md:text-left">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-4">{contentList[selectedContentIndex].title}</h2>
          <p className="text-gray-700 text-sm mb-4">{contentList[selectedContentIndex].description}</p>
          <a
            href="#"
